...
def admin_qr():
    ...
    visitor_list = [{**doc.to_dict(), "id": doc.id} for doc in visitors]
    
    # Optional: dummy notifications if you don't have Firebase for that yet
    notifications = []

    return render_template("qr.html", visitors=visitor_list, notifications=notifications)
