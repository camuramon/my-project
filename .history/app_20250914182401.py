...
def add_visitor():
    ...
    expiry_date = (now.replace(year=now.year + 1)).isoformat()  # 1 year validity

    # ✅ Handle uploaded photo (convert to Base64 string)
    import base64
    ...
    if photo_file and photo_file.filename != "":
        ...
        photo_base64 = ""  # or lagay default image if gusto mo

    # ✅ Generate QR code (still saved as image file for display)
    QR_FOLDER = "static/qr"
    ...
    # ✅ Save visitor record to Firestore
    db.collection("visitors").add({
        ...
        "photo": photo_base64,   # 🔹 base64 format gaya ng nasa screenshot mo
        "qrUrl": qr_url,
        "status": "Active",
        "created_at": firestore.SERVER_TIMESTAMP
    })

    # ✅ Redirect to qr.html to preview
...
def admin_dashboard():
    ...
    for v in visitors_ref:
        ...
        # Status logic: Active kung today pa yung visit, else Expired
