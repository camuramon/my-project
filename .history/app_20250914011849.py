...
def add_visitor():
    ...
    # 1️⃣ Photo (placeholder muna or upload later)
    photo_url = "/static/images/default-visitor.png"  # sample only
    ...
    qr_url = f"data:image/png;base64,{qr_b64}"   # para diretsong ma-display
...
def admin_qr():
    ...
    for v in visitors_ref:
        data = v.to_dict()
        visitors.append(data)
    return render_template("qr.html", visitors=visitors)
